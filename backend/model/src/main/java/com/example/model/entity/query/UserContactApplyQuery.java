...
public class UserContactApplyQuery extends BaseQuery{
	...
	private String receiverUserIdFuzzy;
	...
	public void setReceiverUserIdFuzzy(String receiverUserIdFuzzy) {
		this.receiverUserIdFuzzy = receiverUserIdFuzzy;
	}

	public String getReceiverUserIdFuzzy() {
		return this.receiverUserIdFuzzy;
	}
